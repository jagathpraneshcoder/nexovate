...
const view = (id) => {
  ...
  card.style.transition = "transform 0.5s ease, z-index 0.5s ease, width 0.5s ease, height 0.5s ease, font-size 0.5s ease";
  ...
  card.style.transform = `translate(calc(${centerX / 16}rem - ${offset}rem), calc(${centerY / 16}rem))`; // Move the card to the center
...
const Deck = (props) => {
    return (
        <div className='deck'>
                <Card color={props.deck[0].color} no={props.deck[0].no} img={props.deck[0].img} header={props.deck[0].header} content={props.deck[0].content} className='card-1-nt' id='card-1' onClick={view} />
                <Card color={props.deck[1].color} no={props.deck[1].no} img={props.deck[1].img} header={props.deck[1].header} content={props.deck[1].content} className='card-1-nt' id='card-2' onClick={view} />
                <Card color={props.deck[2].color} no={props.deck[2].no} img={props.deck[2].img} header={props.deck[2].header} content={props.deck[2].content} className='card-1-nt' id='card-3' onClick={view} />
        </div>
    )
}
